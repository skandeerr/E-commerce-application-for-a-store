                ...
                <tbody>
                    <?php
                        ...
                        foreach($categories as $categorie){
                            ...
                            <td>
                                <a href="http://" class="btn btn-success" data-toggle="modal" data-target="#editModal'.$categorie['id'].'">Modifier</a>
                                <a onclick="return popUpDeleteCategorie()" href="supprimer.php?idc='.$categorie['id'].'" class="btn btn-danger">Supprimer</a>
                            </td>
                            </tr>';
                        }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajoutee Categorie</h5>
      ...
      <div class="modal-body">
        <form action="ajout.php" method="POST">
           <div class="form-group">
               <input type="text" name="nom" required class="form-control"placeholder="Nom de la Categorie">

           </div>
           <div class="form-group">
               <textarea name="description" required  class="form-control"placeholder="description de la categorie" ></textarea>
      ...
      <div class="modal-body">
        <form action="modifier.php" method="POST">
           <div class="form-group">
               ...
               <input type="text" value="<?php echo $categorie['nom']    ?>" name="nom" class="form-control"placeholder="Nom de la Categorie">
